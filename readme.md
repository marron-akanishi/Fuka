...
3. FANZAの購入済み商品一覧にアクセスし、ストレージ更新ボタンを押下する  
4. 各商品の左上にチェックが表示されたことを確認
5. お気に入り一覧でもストレージ更新ボタンを押下する
6. 機能一覧に表示されている内容が使えるようになる
7. 新たに商品を購入した場合は3と4を実行
8. 新たにお気に入り登録した場合は5を実行
